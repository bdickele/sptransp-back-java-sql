...
CREATE TABLE ST_AGR_APPLIED_VISA
  (
    ID                NUMBER NOT NULL ,
    ...
    APPLIER_DPT       NUMBER NOT NULL ,
    APPLIER_SENIORITY NUMBER NOT NULL ,
    CREATION_DATE     TIMESTAMP NOT NULL
  ) ;
ALTER TABLE ST_AGR_APPLIED_VISA ADD CONSTRAINT PK_TVI_VISA PRIMARY KEY ( ID ) ;
...
ALTER TABLE ST_GOOD ADD CONSTRAINT ST_GOOD_PK PRIMARY KEY ( ID ) ;
ALTER TABLE ST_GOOD ADD CONSTRAINT ST_GOOD_UN_NAME UNIQUE ( NAME ) ;
ALTER TABLE ST_GOOD ADD CONSTRAINT ST_GOOD_UN_CODE3 UNIQUE ( CODE3 ) ;
ALTER TABLE ST_GOOD ADD CONSTRAINT ST_GOOD_UN_LABELID UNIQUE ( LABEL_ID ) ;
...
CREATE TABLE ST_REQUEST
  (
    ...
    NEXT_VISA_RANK       NUMBER NOT NULL ,
    CREATION_DATE        TIMESTAMP NOT NULL ,
    CREATION_USER        VARCHAR2 (50) NOT NULL ,
    UPDATE_DATE          TIMESTAMP NOT NULL ,
    UPDATE_USER          VARCHAR2 (50) NOT NULL
...
ALTER TABLE ST_AGR_APPLIED_VISA ADD CONSTRAINT ST_AGR_APPLIED_VISA_FK_DPT FOREIGN KEY ( APPLIER_DPT ) REFERENCES ST_DEPARTMENT ( ID ) ;

ALTER TABLE ST_AGR_APPLIED_VISA ADD CONSTRAINT ST_AGR_APPLIED_VISA_FK_EMPL FOREIGN KEY ( ID_EMPLOYEE ) REFERENCES ST_EMPLOYEE ( ID ) ;

ALTER TABLE ST_AGR_APPLIED_VISA ADD CONSTRAINT ST_AGR_APPLIED_VISA_FK_REQUEST FOREIGN KEY ( ID_REQUEST ) REFERENCES ST_REQUEST ( ID ) ;
...
ALTER TABLE ST_AGREEMENT_RULE ADD CONSTRAINT ST_AGR_RULE_FK_GOOD FOREIGN KEY ( ID_GOOD ) REFERENCES ST_GOOD ( ID ) ;
...
ALTER TABLE ST_REQUEST ADD CONSTRAINT ST_REQUEST_FK_GOOD FOREIGN KEY ( ID_GOOD ) REFERENCES ST_GOOD ( ID ) ;
