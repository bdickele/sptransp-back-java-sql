...
ALTER TABLE ST_DEPARTMENT ADD CONSTRAINT ST_DEPARTMENT_UN_CODE UNIQUE ( CODE ) ;
...
ALTER TABLE ST_DESTINATION ADD CONSTRAINT ST_DESTINATION_UN_CODE UNIQUE ( CODE ) ;
...
ALTER TABLE ST_EMPLOYEE_AUD ADD CONSTRAINT ST_EMPLOYEE_AUD_PK PRIMARY KEY ( ID, VERSION ) ;
...
ALTER TABLE ST_GOODS ADD CONSTRAINT ST_GOOD_UN_CODE UNIQUE ( CODE ) ;
...
ALTER TABLE ST_REQUEST ADD CONSTRAINT ST_REQUEST_UN_REF UNIQUE ( REFERENCE ) ;
...
ALTER TABLE ST_REQUEST ADD CONSTRAINT ST_REQUEST_FK_ARRIVAL FOREIGN KEY ( ID_ARRIVAL ) REFERENCES ST_DESTINATION ( ID ) ;

ALTER TABLE ST_REQUEST ADD CONSTRAINT ST_REQUEST_FK_CUSTOMER FOREIGN KEY ( ID_CUSTOMER ) REFERENCES ST_CUSTOMER ( ID ) ;

ALTER TABLE ST_REQUEST ADD CONSTRAINT ST_REQUEST_FK_DEPARTURE FOREIGN KEY ( ID_DEPARTURE ) REFERENCES ST_DESTINATION ( ID ) ;
