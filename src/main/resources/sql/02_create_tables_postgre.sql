...
CREATE TABLE sptransp.ST_CUSTOMER_AUTH
  (
    ID                NUMERIC ,
    ID_CUSTOMER       NUMERIC NOT NULL ,
    PASSWORD_CUSTOMER Character Varying (1024)
  ) ;
...
CREATE TABLE sptransp.ST_PROFILE
  ( PROFILE Character Varying (200) NOT NULL
  ) ;
ALTER TABLE sptransp.ST_PROFILE ADD CONSTRAINT ST_PROFILE_PK PRIMARY KEY ( PROFILE ) ;


CREATE TABLE sptransp.ST_PROFILE_ROLE
  (
    USER_PROFILE Character Varying (200) NOT NULL ,
    USER_ROLE    Character Varying (200) NOT NULL
  ) ;
ALTER TABLE sptransp.ST_PROFILE_ROLE ADD CONSTRAINT ST_PROFILE_ROLE_PK PRIMARY KEY ( USER_PROFILE, USER_ROLE ) ;
...
CREATE TABLE sptransp.ST_ROLE_PROFILE
  (
    PROFILE Character Varying (200) NOT NULL ,
    ROLE    Character Varying (200) NOT NULL
  ) ;
ALTER TABLE sptransp.ST_ROLE_PROFILE ADD CONSTRAINT ST_ROLE_PROFILE_PK PRIMARY KEY ( PROFILE, ROLE ) ;
...
ALTER TABLE sptransp.ST_CUSTOMER_AUTH ADD CONSTRAINT FK_ST_CUSTOMER_AUTH_CUSTOMER FOREIGN KEY ( ID_CUSTOMER ) REFERENCES sptransp.ST_CUSTOMER ( ID ) ;
...
ALTER TABLE sptransp.ST_ROLE_PROFILE ADD CONSTRAINT FK_ST_ROLE_PROFILE_PROFILE FOREIGN KEY ( PROFILE ) REFERENCES sptransp.ST_PROFILE ( PROFILE ) ;
