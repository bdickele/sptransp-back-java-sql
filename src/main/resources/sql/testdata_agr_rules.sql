...
INSERT INTO ST_AGREEMENT_RULE(ID, VERSION, ID_DESTINATION, ID_GOODS, REQ_ALLOWED, CREATION_DATE, CREATION_USER, UPDATE_DATE, UPDATE_USER)
VALUES(2, 1, 2, 1, 1, CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
...
INSERT INTO ST_AGREEMENT_RULE(ID, VERSION, ID_DESTINATION, ID_GOODS, REQ_ALLOWED, CREATION_DATE, CREATION_USER, UPDATE_DATE, UPDATE_USER)
VALUES(3, 1, 1, 5, 0, CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');
INSERT INTO ST_AGREEMENT_RULE(ID, VERSION, ID_DESTINATION, ID_GOODS, REQ_ALLOWED, CREATION_DATE, CREATION_USER, UPDATE_DATE, UPDATE_USER)
VALUES(4, 1, 2, 5, 0, CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, 'admin');